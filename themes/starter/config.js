...
const CONFIG = {
  ...
  STARTER_HERO_PREVIEW_IMAGE: '/images/starter/hero/qrcode.png', // 产品预览图 ，默认读取public目录下图片

  // 特性区块
  STARTER_FEATURE_ENABLE: true, // 特性区块开关
  STARTER_FEATURE_TITLE: '特性', // 特性
  STARTER_FEATURE_TEXT_1: '恰切CHEKISETSU的主要特性', // 特性
  STARTER_FEATURE_TEXT_2:
    '恰切CHEKISETSU的愿景是帮助您简单、无感知地管理、参加与回顾Live Idol特典会，聚焦于核心内容的体验', // 特性
  ...
  STARTER_BLOG_TEXT_2:
    '这里会发布一些关于恰切CHEKISETSU的最新动态，包括动向、计划，以及新功能特性',
  ...
  STARTER_CONTACT_EMAIL_TEXT: 'terence.wang@chekisetsu.fun',
  ...
  STARTER_POST_REDIRECT_URL: 'https://chekisetsu.fun', // 重定向域名
